...
class PostsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $post->url = str_slug('Mi primer Documento');
        ...
        $post->url = str_slug('Mi segundo Documento');
        ...
        $post->url = str_slug('Mi Tercer Documento');
        ...
        $post->url = str_slug('Mi Cuarto Documento');
        ...
        $post->url = str_slug('Mi Quinto Documento');
        ...
        $post->url = str_slug('Mi Sexto Documento');
